 ...
 * 2015年8月12日 Created
 */
package com.xingren.test.generate.feed.xml;
...
public class InsertSQLMap {
    ...
    public static void main(String[] args) throws Exception {
        File srcDir = new File("C:/java/SDB_workspace/shundaibang/sdb-feed/src/main/resources/sqlmap");
    ...
    public static void GenerateOne(File srcFile, File descFile) throws Exception {
        ...
        Template t = ve.getTemplate("feed/sqlmap.vm");

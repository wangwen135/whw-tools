 ...
 * 2015年8月17日 Created
 */
package com.xingren.generate.entity;

import com.xingren.generate.GenerateHelp;
...
public class ColumnEntity {
    ...
    public String getJavaGetMethod() {
        if ("java.lang.Boolean".equals(javaTypeClass)) {
            return "is" + getUpProperty();
        } else {
    ...
    public String toString() {
        return "ColumnEntity [name=" + name + ", property=" + property + ", type=" + type + ", size=" + size + ", digits=" + digits + ", defaultValue="
                + defaultValue + ", comments=" + comments + ", nullable=" + nullable + ", primaryKey=" + primaryKey + ", unique=" + unique + ", unsigned="
                + unsigned + ", autoIncrement=" + autoIncrement + "]";
    }

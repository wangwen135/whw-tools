package com.xingren.swing.feature.digest;
 ...
 *
 */
public class SHA1IFrame extends BaseJInternalFrame {

    private static final Logger log = LoggerFactory.getLogger(SHA1IFrame.class);
    ...
    public SHA1IFrame() {
        ...
        btn_encode.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    byte[] b = CodecUtils.sha1(inputText.getBytes(charset));
                    ...
                    log.error("编码错误", ex);
                    JOptionPane.showMessageDialog(SHA1IFrame.this, "编码错误：" + ex.getMessage());
                }
            }
        });
        ...
        gbc_txt_up.anchor = GridBagConstraints.NORTH;
        ...
        gbc_txt_lower.anchor = GridBagConstraints.NORTH;
        ...
        btn_compare.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (text.equalsIgnoreCase(text2)) {
                    JOptionPane.showMessageDialog(SHA1IFrame.this, "结果 与 目标值 匹配");
                } else {
                    JOptionPane.showMessageDialog(SHA1IFrame.this, "结果 与 目标值 不匹配", "不匹配", JOptionPane.ERROR_MESSAGE);
                }
            }
        });
